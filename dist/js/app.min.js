...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ classesToSelector)\n/* harmony export */ });\nfunction classesToSelector(classes) {\n  if (classes === void 0) {\n    classes = '';\n  }\n  return `.${classes.trim().replace(/([\\.:!+\\/])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://autoheaven/./node_modules/swiper/shared/classes-to-selector.mjs?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var slick_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! slick-slider */ \"./node_modules/slick-slider/slick/slick.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\r\n\r\n\r\nif(jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery-slider').length > 0){\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery-slider').slick({\r\n        arrows: true,\r\n        dots: true,\r\n        adaptiveHeight: false, // use align-items: flex-start on slick-track\r\n        slidesToShow: 1,\r\n        slidesToScroll: 1,\r\n        speed: 1000,\r\n        easing: 'ease',\r\n        lazyLoad: 'progressive',\r\n        // cssEase: 'linear',\r\n        infinite: true,\r\n        initialSlide: 0,\r\n        autoplay: false,\r\n        autoplaySpeed: 1500,\r\n        pauseOnFocus: true,\r\n        pauseOnHover: true,\r\n        pauseOnDotHover: true,\r\n        draggable: false,\r\n        swipe: false,\r\n        touchThreshold: 10,\r\n        touchMove: true,\r\n        waitForAnimate: true,\r\n        centerMode: false,\r\n        variableWidth: true,\r\n        rows: 0, \r\n        slidesPerRow: 1,\r\n        vertical: false,\r\n        verticalSwiping: false,\r\n        appendArrows: jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery__arrows'),\r\n        appendDots: jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery__dots'),\r\n        responsive: [\r\n            {\r\n                breakpoint: 965, \r\n                settings: {\r\n                    variableWidth: false,\r\n                    swipe: true,\r\n                    draggable: true,\r\n                    infinite: false,\r\n                }\r\n            }\r\n        ]\r\n    });\r\n\r\n    \r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.slick-prev').addClass('slick-disabled').off('click').css('cursor', 'default');\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery-slider').on('beforeChange', function(event, slick, currentSlide, nextSlide){\r\n        if (nextSlide === slick.slideCount - 1){\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery .slick-next').addClass('slick-disabled').off('click').css('cursor', 'default');\r\n        } else {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery .slick-next').removeClass('slick-disabled').on('click', function(){\r\n                jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery-slider').slick('slickNext');\r\n            }).css('cursor', 'pointer');\r\n        }\r\n        if (nextSlide === 0){\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery .slick-prev').addClass('slick-disabled').off('click').css('cursor', 'default');\r\n        } else {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery .slick-prev').removeClass('slick-disabled').on('click', function(){\r\n                jquery__WEBPACK_IMPORTED_MODULE_1__('.gallery-slider').slick('slickPrev')\r\n            }).css('cursor', 'pointer');\r\n        }\r\n        \r\n    })\r\n\r\n}\r\n\r\nif (jquery__WEBPACK_IMPORTED_MODULE_1__('.services-slider').length > 0){\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.services-slider').slick({\r\n        slidesToShow: 1,\r\n        slidesToScroll: 1,\r\n        arrows: true,\r\n        adaptiveHeight: false,\r\n        dots: true,\r\n        speed: 1500,\r\n        infinite: true,\r\n        variableWidth: true,\r\n        centerMode: false,\r\n        easing: 'ease-in',\r\n        rows: 0,\r\n        slidesPerRow: 0,\r\n        responsive: [\r\n            {\r\n                breakpoint: 1300, \r\n                settings: {\r\n                    centerMode: true,\r\n                }\r\n            },\r\n            {\r\n                breakpoint: 372,\r\n                settings: {\r\n                    arrows: false,\r\n                    variableWidth: false,\r\n                    centerMode: true,\r\n                    slidesToShow: 1,\r\n                    slidesToScroll: 2,\r\n                }\r\n            }\r\n        ]\r\n        \r\n\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.services-slider').on('beforeChange', (event, slick, currentSlide, nextSlide) => {\r\n        let nextIndex = currentSlide + 1;\r\n        if(currentSlide-1 == nextSlide) {\r\n            nextIndex = currentSlide - 1;\r\n        } else if (currentSlide === 0 && nextSlide == slick.slideCount - 1){\r\n            nextIndex = -1;\r\n        } else if (currentSlide === slick.slideCount - 1 && nextSlide === 0){\r\n            nextIndex = slick.slideCount;\r\n        }\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(`.services-slider .idea-item[data-slick-index=\"${nextIndex}\"]`).addClass('slick-target');\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(jquery__WEBPACK_IMPORTED_MODULE_1__(slick.$slides.get(currentSlide)).find('.idea-item__information').addClass('closing'))\r\n        setTimeout(() => {\r\n            jquery__WEBPACK_IMPORTED_MODULE_1__(jquery__WEBPACK_IMPORTED_MODULE_1__(slick.$slides.get(currentSlide)).find('.idea-item__information').removeClass('closing'))\r\n        }, 1500)\r\n    });\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.services-slider').on('afterChange', () => {\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.slick-slide').removeClass('slick-target');\r\n    });\r\n}\r\n\r\nif (jquery__WEBPACK_IMPORTED_MODULE_1__('.tips-slider').length > 0 ){\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.tips-slider').slick({\r\n        arrows: true,\r\n        dots: true,\r\n        infinite: true,\r\n        centerMode: true,\r\n        slidesToShow: 3,\r\n        slidesToScroll: 1,\r\n        variableWidth: true,\r\n        slidesPerRow: 0,\r\n        rows: 0,\r\n        speed: 1000,\r\n        responsive: [\r\n            {\r\n                breakpoint: 465, \r\n                settings: {\r\n                    centerMode: true,\r\n                    slidesToShow: 1,\r\n                    variableWidth: false,\r\n                }\r\n            },\r\n        ]\r\n    })\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.tips-slider').on('beforeChange', (event, slick, currentSlide, nextSlide) => {\r\n        let nextIndex = currentSlide + 1;\r\n        if(currentSlide-1 == nextSlide) {\r\n            nextIndex = currentSlide - 1;\r\n        } else if (currentSlide === 0 && nextSlide == slick.slideCount - 1){\r\n            nextIndex = -1;\r\n        } else if (currentSlide === slick.slideCount - 1 && nextSlide === 0){\r\n            nextIndex = slick.slideCount;\r\n        }\r\n        console.log(nextIndex)\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__(`.tips-slider .slick-slide[data-slick-index=\"${nextIndex}\"]`).addClass('slick-target');\r\n    })\r\n    jquery__WEBPACK_IMPORTED_MODULE_1__('.tips-slider').on('afterChange', () => {\r\n        jquery__WEBPACK_IMPORTED_MODULE_1__('.slick-slide').removeClass('slick-target');\r\n    });   \r\n}\n\n//# sourceURL=webpack://autoheaven/./src/js/modules/slickSlider.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ \"./node_modules/swiper/swiper-bundle.mjs\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\r\n\r\nconst shareSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.share-slider', {\r\n    // ------------------------------------ BASE ------------------------------------ //\r\n    init: true,\r\n    enabled: true,\r\n    createElements: true, \r\n    speed: 5000,\r\n    slidesPerView: 'auto',\r\n    initialSlide: 1,\r\n    spaceBetween: 16,\r\n    preventInteractionOnTransition: false,\r\n    normalizeSlideIndex: true,\r\n    grabCursor: false,\r\n    slideToClickedSlide: false,\r\n   \r\n    centeredSlides: true,\r\n    centeredSlidesBounds: true,\r\n    \r\n    freeMode: {\r\n        enabled: true,\r\n    },\r\n\r\n});\r\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_1__('.share-slider').on('mousemove', function(event){\r\n    const mouseX = event.pageX;\r\n    \r\n    const distanceFromLeft = mouseX;\r\n    const distanceFromRight = jquery__WEBPACK_IMPORTED_MODULE_1__(window).width() - mouseX;\r\n    \r\n    const minDistance = 500; // Minimum distance from the edge to trigger event\r\n    if (distanceFromLeft < minDistance) {\r\n        shareSlider.setProgress(0, 2500 + 5000 * (distanceFromLeft / minDistance))\r\n      } else if (distanceFromRight < minDistance) {\r\n        shareSlider.setProgress(1, 2500 + 5000 * (distanceFromRight / minDistance))\r\n      } else {\r\n        shareSlider.setProgress(0.5, 7000)\r\n      }\r\n    \r\n})\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_1__('.share-slider').on('mouseleave', function(){\r\n    shareSlider.setProgress(0.5, 7000)\r\n})\n\n//# sourceURL=webpack://autoheaven/./src/js/modules/swiper.js?");
